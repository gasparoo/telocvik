...
?>
  ...
  <div class="container mx-auto px-4 py-8 w-full md:w-1/2 lg:w-1/3 xl:w-1/3 mt-8">
    <div class="bg-white shadow-md rounded-lg p-6 mt-8">
      ...
      <h1 class="text-2xl font-semibold text-gray-700 mb-6">Přihlášení</h1>
      <form action="_inc/UserController.php" method="POST">
        ...
        <div class="flex items-center justify-between">
          <button class="bg-blue-500 hover:bg-blue-700 text-white w-1/4 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" name="loginBtn" type="submit">
            Přihlášení
          </button>
